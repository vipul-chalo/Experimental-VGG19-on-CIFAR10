...
# building VGGNet Model from scratch
def cifar10_custom_VGG22(image_shape=IMG_SIZE, weights=False):
    ''' Define a tf.keras model for 10 categories classification using VGGNet model structure
    Arguments:
